#Benchmark testing of Channel Client
	...
	(
	    ...
	    * the command output also shows the environment and the package used for the benchmark exection:
	        goos: darwin
            goarch: amd64
            pkg: github.com/jxu86/fabric-sdk-go-gm/test/performance/pkg/client/channel
...
##### - Benchmark command examples:
    ...
    PASS
    ok  	github.com/jxu86/fabric-sdk-go-gm/test/performance/pkg/client/channel	6.618s
    ...
    PASS
    ok  	github.com/jxu86/fabric-sdk-go-gm/test/performance/pkg/client/channel	68.788s
    ...
    PASS
    ok  	github.com/jxu86/fabric-sdk-go-gm/test/performance/pkg/client/channel	213.246s
    ...
    PASS
    ok  	github.com/jxu86/fabric-sdk-go-gm/test/performance/pkg/client/channel	433.668s
    ...
    PASS
    ok  	github.com/jxu86/fabric-sdk-go-gm/test/performance/pkg/client/channel	926.270s
...
###Benchmark data (using Prometheus report)
    ...
    ie look at: "github.com/jxu86/fabric-sdk-go-gm/pkg/client/channel/chclientrun.go" to see how ClientMetrics is created and 
    metrics added in the code. 
    "github.com/jxu86/fabric-sdk-go-gm/pkg/client/channel/metrics.go" creates metrics structures to be used in the file above.
