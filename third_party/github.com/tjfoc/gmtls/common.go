...
type ConnectionState struct {
	...
	PeerCertificates            []*sm2.Certificate   // certificate chain presented by remote peer
	VerifiedChains              [][]*sm2.Certificate // verified chains built from PeerCertificates
...
type ClientSessionState struct {
	...
	serverCertificates []*sm2.Certificate   // Certificate chain presented by the server
	verifiedChains     [][]*sm2.Certificate // Certificate chains we built for verification
}
...
type Config struct {
	...
	VerifyPeerCertificate func(rawCerts [][]byte, verifiedChains [][]*sm2.Certificate) error

	// RootCAs defines the set of root certificate authorities
	// that clients use when verifying server certificates.
	// If RootCAs is nil, TLS uses the host's root CA set.
	RootCAs *sm2.CertPool
